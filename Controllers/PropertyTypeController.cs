...
namespace RealEstateApp.Api.Controllers
{
    ...
    public class PropertyTypeController : ControllerBase
    {
        ...
        public async Task<IActionResult> List()
        {
            ...
            var infoList = new List<PropertyFieldInfoDTO<PropertyType>>();
            result.ForEach(x => infoList.Add(new PropertyFieldInfoDTO<PropertyType>(x)));
        ...
        public async Task<IActionResult> Post([FromBody] PropertyFieldCreateRequestDTO request)
        {
            ...
            var item = _set.Add(new PropertyType(value));
